...
describe("scheduler", () => {
  it("reconnait un lundi programme", () => {
    expect(isScheduledRunWindow(new Date("2026-07-06T10:00:00.000Z"))).toBe(true);
  });

  it("reconnait un mercredi programme", () => {
    expect(isScheduledRunWindow(new Date("2026-01-07T11:00:00.000Z"))).toBe(true);
  });

  it("ignore les jours hors cadence", () => {
    expect(isScheduledRunWindow(new Date("2026-01-08T11:00:00.000Z"))).toBe(false);
  });
